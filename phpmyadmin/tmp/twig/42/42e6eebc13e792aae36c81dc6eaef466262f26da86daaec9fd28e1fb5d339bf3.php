...
class __TwigTemplate_b4a1adce9e48cf4a5aeec022947672ed664efc5be5f4afd842edc0b348708deb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
            ...
            // line 80
            echo "  ";
            echo call_user_func_array($this->env->getFilter('error')->getCallable(), [sprintf(_gettext("Not enough privilege to view server variables and settings. %s"), PhpMyAdmin\Html\Generator::linkToVarDocumentation("show_compatibility_56",             // line 81
...
";
    ...
    {
        return new Source("", "server/variables/index.twig", "/home/six4/public_html/phpmyadmin/templates/server/variables/index.twig");
    }
}
