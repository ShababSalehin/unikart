...
class SellerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $user_ids = User::where('user_type', 'seller')->where(function ($user) use ($sort_search) {
                $user->where('name', 'like', '%' . $sort_search . '%')->orWhere('id', 'like', '%' . $sort_search . '%')->orWhere('email', 'like', '%' . $sort_search . '%');
            })->pluck('id')->toArray();
    ...
    public function edit($id)
    {
        ...
        $shop = Shop::where('user_id',$seller->user_id)
             ->select('shipping_cost')
             ->first();
            // dd($shop);

        return view('backend.sellers.edit', compact('seller', 'shop'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($user->save()) {
            if ($seller->save()) {
            $affected = Shop::where('user_id', $seller->user_id)
