...
class StaffController extends Controller
{
    ...
    {       
           if (User::where('email', $request->email)->first() && User::where('phone', $request->mobile)->first() != null) {
               flash(translate('Email & Phone already used'))->error();
               return back();
           }
           ...
           elseif (User::where('phone', $request->mobile)->first() != null) {
