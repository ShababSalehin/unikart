    ...
    public function sendResetLinkEmail(Request $request)
    {
        if (filter_var($request->email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($user != null) {
                ...
                $array['content'] = translate('Your Password Reset Code is: ').$user->verification_code;
            ...
            if ($user != null) {
                $user->verification_code = rand(100000,999999);
                $user->save();
                sendSMS($user->phone, env('APP_NAME'),' Your Password Reset Code is: '.$user->verification_code);
