...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $category->shop_banner = $request->shop_banner;
        $category->appbanner_link = $request->appbannerlink;
    ...
    public function update(Request $request, $id)
    {
        ...
        $category->banner = $request->banner;
        $category->shop_banner = $request->shop_banner;
        $category->appbanner_link = $request->itemid;
        $category->appbanner_type = $request->appbanner_type;
        $category->icon = $request->icon;
        $category->meta_title = $request->meta_title;
        $category->description = $request->description;
        $category->meta_description = $request->meta_description;
    ...
    public function banner_linkdata(Request $request){

        if($request->value == "Brand"){
            $linkdata = Brand::all();
        }elseif($request->value == "Shop"){
            $linkdata = Shop::all();
        }elseif($request->value == "Category"){
            $linkdata = Category::all();
        }elseif($request->value == "Product"){
            $linkdata = Product::all();
        }elseif($request->value == "FlashDeal"){
            $linkdata = FlashDeal::select('id','title as name')->get();
        }
