            ...
            if(!empty($request->products)){
                foreach ($request->products as $key => $product) {
                    ...
                    if($flash_deal->campaign_type=="Others"){
                        ...
                        if(!empty($root_product->net_total_discount)){
                            $discount_percent = ($root_product->net_total_discount * 100) / $root_product->unit_price;
                          }else{
                            $discount_percent = 0;
                          }
                        $root_product->discount_percent = $discount_percent;
...
public function update(Request $request, $id)
    ...
    public function update_03_07_2022(Request $request, $id)
    {
        if(Auth::user()->user_type == 'admin') {
