    ...
    public function store(Request $request)
    {
        ...
        foreach ($seller_products as $seller_product) {
            ...
            foreach ($seller_product as $cartItem) {
                ...
                //  ->select('flash_deals.title','flash_deals.minimum_amount')->first();
                    ...
                    //             if( (count($order_check)<2) || (count($order_check) == 2 && $order_check[0]['delivery_status'] == 'cancelled'))
                    //             {
                    ...
                    //                                 $disc = ($flashDeal->discount) / 100;
                    //                             } elseif ($flashDeal->discount_type == 'amount') {
                    //                                 $disc = $flashDeal->discount;
                    //                             }
                    //                         }    
                    //                     }
