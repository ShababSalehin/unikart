...
class BusinessSettingsController extends Controller
{
    ...
    public function app_footer()
    {
    	...
    	return view('backend.setup_configurations.app_footer');
    }
    ...
    public function app_slider()
    {
    	...
    	return view('backend.setup_configurations.app_slider');
    }
    ...
    public function create_push_notification(){
        $campaign = FlashDeal::where('status',1)->get();
        return view('backend.setup_configurations.custom_pushnotification',compact('campaign'));
    }

    public function custom_push_store(Request $request){
        
       NotificationUtility::CustomPushNotification($request);
        
       flash('Custom Push Notification Inserted Successfully')->success();
       return back();
    }
}
