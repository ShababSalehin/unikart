...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::post('/refund-request-status-change', 'RefundRequestController@status_change')->name('status_change');
...
Route::group(['middleware' => ['user', 'verified']], function(){
    ...
    Route::get('make_review/{id}', 'RefundRequestController@make_review')->name('make_review');
});
