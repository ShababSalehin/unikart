...
Route::prefix('v2/auth')->group(function () {
    ...
    Route::post('otplogin', 'Api\V2\AuthController@otplogin');
    Route::post('confirm_otplogin', 'Api\V2\AuthController@confirm_otplogin');
    Route::post('confirm-otplogin-temp', 'Api\V2\AuthController@confirm_otplogin_tempuser');
    Route::post('update_name', 'Api\V2\AuthController@update_name');
    ...
    Route::post('registation_login_with_otp', 'Api\V2\AuthController@registation_login_with_otp');
});
...
Route::prefix('v2')->group(function () {
    ...
    Route::post('seller/create-conversation', 'Api\V2\ChatController@seller_create_conversation')->middleware('auth:api');
    ...
    Route::get('home_banner_two', 'Api\V2\BannerController@home_banner_two');
    Route::get('home_banner_three', 'Api\V2\BannerController@home_banner_three');
    Route::get('blogs', 'Api\V2\BannerController@blog');
    ...
    // added by nurul
    Route::get('purchase-history-detailscode/{id}', 'Api\V2\PurchaseHistoryController@detailscode');
    Route::post('follow-shop', 'Api\V2\ShopController@follow_shop')->middleware('auth:api');
    Route::post('check-followshop', 'Api\V2\ShopController@check_followshop')->middleware('auth:api');
    Route::post('unfollow-shop', 'Api\V2\ShopController@unfollow_shop')->middleware('auth:api');
    Route::post('followed-shop', 'Api\V2\ShopController@my_followed_shop')->middleware('auth:api');
    Route::post('coupon-applyed', 'Api\V2\ShopController@applyed_coupon_code')->middleware('auth:api');
    Route::post('new_coupon_list', 'Api\V2\ShopController@new_coupon_list')->middleware('auth:api');
    Route::post('my-review', 'Api\V2\ShopController@my_review')->middleware('auth:api');
    Route::get('purchase-history-itemsbycode/{code}', 'Api\V2\PurchaseHistoryController@itemsbycode');
    Route::post('sortby-price', 'Api\V2\ShopController@sortby_price');
    Route::post('profile/subscribe', 'Api\V2\ProfileController@subscribe');
    Route::get('products/offerList', 'Api\V2\ProductController@offerList');
    Route::get('products/offerListAppHome', 'Api\V2\ProductController@offerListAppHome');
    Route::get('products/offerCount', 'Api\V2\ProductController@offerCount');

    Route::get('top/categories', 'Api\V2\CategoryController@categories_top');
    Route::get('section/product_for_you', 'Api\V2\ProductController@product_for_you');
    Route::get('new-coupon', 'Api\V2\ShopController@new_coupon');
    Route::get('app-footer', 'Api\V2\ShopController@app_footer');


    Route::get('profile/order-confirmed', 'CheckoutController@order_confirmed');

    Route::post('get-all-order-code', 'Api\V2\ShopController@get_all_order_code')->middleware('auth:api');
    Route::post('get-firebase-notification', 'Api\V2\ShopController@get_firebase_notification')->middleware('auth:api');

    Route::post('filterby-cetegory', 'Api\V2\ShopController@filterby_category');
    Route::post('filterby-featires', 'Api\V2\ShopController@filterby_features');
    Route::post('payments/pay/byordercod', 'Api\V2\PaymentController@cashOnDelivery')->middleware('auth:api');

    Route::post('profile/email-verification', 'Api\V2\ProfileController@new_verify');
    Route::post('profile/update-email', 'Api\V2\ProfileController@update_email')->middleware('auth:api');
    Route::put('profile/update-paymentmethood', 'Api\V2\ProfileController@update_payment_info');
    ...
    Route::post('order/sendsmsmsilpushno', 'Api\V2\OrderController@sendsmsmsilpushno')->middleware('auth:api');
    Route::post('orderCancel', 'Api\V2\OrderController@cancel')->middleware('auth:api');
    Route::get('cart-summary/{user_id}', 'Api\V2\CartController@summary')->middleware('auth:api');
    Route::post('refund-request/get-list', 'Api\V2\RefundRequestController@get_list')->middleware('auth:api');
    ...
    Route::post('filter/find_brands', 'Api\V2\FilterController@find_brands');
    ...
    Route::post('carts/add-for-guest', 'Api\V2\CartController@add_for_guest');
    ...
    Route::post('guest_carts/{temp_user_id}', 'Api\V2\CartController@temp_getList');
    Route::post('carts-temp', 'Api\V2\CartController@temp_user_destroy');
    ...
    Route::get('bkash/api/webpage/{token}/{amount}/{order_id}', 'Api\V2\BkashController@webpage')->name('api.bkash.webpage');
    Route::any('bkash/api/checkout/{token}/{amount}/{order_id}', 'Api\V2\BkashController@checkout')->name('api.bkash.checkout');
    Route::any('bkash/api/callback/{token}/{order_id}', 'Api\V2\BkashController@callback')->name('api.bkash.callback');
    ...
    Route::put('profile/update_basic', 'Api\V2\ProfileController@update_basic')->middleware('auth:api');
    Route::put('profile/update_password', 'Api\V2\ProfileController@update_password')->middleware('auth:api');
    ...
    Route::get('flash-deal-with-products', 'Api\V2\FlashDealController@flash_deal_with_products');
    Route::get('brand_campaign', 'Api\V2\FlashDealController@brand_campaign');
    Route::post('brand_campaign_products', 'Api\V2\FlashDealController@brand_campaign_products');
});
