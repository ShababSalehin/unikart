...
<div class="card-header mb-2">
   <h3 class="h6">{{translate('Edit Your Random Coupon')}}</h3>
</div>
...
@endphp
   <div class="form-group row">
  <label class="col-lg-3 col-from-label">{{translate('How Many Time Can Use')}}</label>
  <div class="col-lg-9">
     <input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('How Many Time Can Use')}}" name="max_times" class="form-control" value="{{ $obj->max_times }}" required>
  </div>
</div>
...
<div class="form-group row">
    <label class="col-sm-3 control-label" for="remarks">{{translate('Remarks')}}</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" value="{{ $coupon->remarks }}" name="remarks">
    </div>
</div>
