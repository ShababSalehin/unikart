			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
	                    <label class="col-md-3 col-from-label">{{ translate('Header Logo') }}<small>({{ translate('700x180') }})</small></label>
						<div class="col-md-8">
					...
					<div class="border-top pt-3">
						<div class="form-group row">
		                    <label class="col-md-3 col-from-label">{{ translate('Topbar Banner') }} <small>(1220x32)</small></label>
							<div class="col-md-8">
			                    <div class=" input-group " data-toggle="aizuploader" data-type="image">
			                        <div class="input-group-prepend">
			                            <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse') }}</div>
						...
						<div class="form-group row">
		                    <label class="col-md-3 col-from-label">{{ translate('PDF for 20% Save') }}</label>
							<div class="col-md-8">
			                    <div class=" input-group " data-toggle="aizuploader" data-type="document">
			                        ...
			                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
									<input type="hidden" name="types[]" value="newcustomerpdf">
			                        <input type="hidden" name="newcustomerpdf" class="selected-files" value="{{ get_setting('newcustomerpdf') }}">
			                    </div>
			                    <div class="file-preview"></div>
							</div>
		                </div>
