                    ...
                    <div class="col-md-4">
                        <form class="" id="sort_cities" action="" method="GET">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" id="search" name="search"@isset($sort_search) value="{{ $sort_search }}" @endisset placeholder="{{ translate('Type Area Name & Enter') }}">
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach($areas as $key => $area)
                                <tr>
                                    ...
                                    <td>{{ $area->name }}</td>
                                    <td>{{ !empty($area->citi->name) ? $area->citi->name : '' }}</td>
                                    <td class="text-right">
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('areas.edit', ['id'=>$area->id]) }}" title="{{ translate('Edit') }}">
    			...
    			<div class="card-body">
    				<form action="{{ route('areas.store') }}" method="POST">
                        ...
                        <!-- <div class="form-group mb-3">
    						...
    						<input type="number"  placeholder="{{translate('Code')}}" name="code" class="form-control" required>
    					</div> -->
