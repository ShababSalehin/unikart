                    ...
                    <div class="col-md-4">
                        <form class="" id="sort_cities" action="" method="GET">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" id="search" name="search"@isset($sort_search) value="{{ $sort_search }}" @endisset placeholder="{{ translate('Type Thana & Enter') }}">
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="col-md-5">
    		<div class="card">
    			<div class="card-header">
    				<h5 class="mb-0 h6">{{ translate('Add New Thana') }}</h5>
    			</div>
    			<div class="card-body">
    				<form action="{{ route('cities.store') }}" method="POST">
    					...
    					<div class="form-group mb-3">
    						...
    						<input type="text" placeholder="{{translate('Thana')}}" name="name" class="form-control" required>
    					</div>
