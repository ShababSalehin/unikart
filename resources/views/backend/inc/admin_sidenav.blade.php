    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                            <a href="{{route('purchase_return.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('All Purchase Return')}}</span>
                            </a>
                        </li>
                        @endif
                        @if(Auth::user()->user_type == 'admin' || in_array('4', json_decode(Auth::user()->staff->role->permissions)))
                        ...
                        <li class="aiz-side-nav-item">
                            <a href=" {{ route('purchase_return.create') }}" class="aiz-side-nav-link {{ areActiveRoutes(['Return', 'Return'])}}">
                                <span class="aiz-side-nav-text">{{translate('Add Purchase Return')}}</span>
                            </a>
                        </li>
                        @endif
                    </ul>
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                @php 
                 $newewquest = \App\RefundRequest::where('admin_seen',0)->get();
                @endphp
                    <li class="aiz-side-nav-item">
                        <a href="{{route('refund_requests_all')}}" class="aiz-side-nav-link {{ areActiveRoutes(['refund_requests_all', 'reason_show'])}}">
                            ...
                            @if(count($newewquest) >0)<span class="badge badge-inline badge-success">{{ translate('New') }}</span>@endif
                        </a>
                    </li>
                   <li class="aiz-side-nav-item">
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                	 <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('customers.create')}}">
            ...
            <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('orderReport.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['orderReport.index'])}}">
                        <span class="aiz-side-nav-text">{{ translate('Confirm Order Report') }}</span>
                    </a>
                </li>      
                        
                        
                <li class="aiz-side-nav-item">
                    <a href="{{ route('pendingOrderProductStockReport.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['pendingOrderProductStockReport.index'])}}">
                        <span class="aiz-side-nav-text">{{ translate('Pending Order Product Inventory Report') }}</span>
                    </a>
                </li> 
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('in_house_sale_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['in_house_sale_report.index'])}}">
                        <span class="aiz-side-nav-text">{{ translate('ProductWise Sales Report') }}</span>
                    </a>
                </li>
                  
                <li class="aiz-side-nav-item">
                    <a href="{{ route('product_wise_sales_details') }}" class="aiz-side-nav-link {{ areActiveRoutes(['product_wise_sales_details'])}}">
                        <span class="aiz-side-nav-text">{{ translate('ProductWise Sales Details') }}</span>
                    </a>
                </li>
                
                
                <li class="aiz-side-nav-item">
                    <a href="{{ route('coupon_report_details') }}" class="aiz-side-nav-link {{ areActiveRoutes(['coupon_report_details'])}}">
                        <span class="aiz-side-nav-text">{{ translate('Coupon Report') }}</span>
                    </a>
                </li>
                
                <li class="aiz-side-nav-item">
                    <a href="{{ route('first_order_customer.report') }}" class="aiz-side-nav-link {{ areActiveRoutes(['first_order_customer.report'])}}">
                        <span class="aiz-side-nav-text">First Order Customers Report</span>
                    </a>
                </li> 
                        
                        
                <li class="aiz-side-nav-item">
                    <a href="{{ route('topSalesReport.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['salesReport.index'])}}">
                        <span class="aiz-side-nav-text">{{ translate('Top Sales Report') }}</span>
                    </a>
                </li>
                
                
                <li class="aiz-side-nav-item">
                    <a href="{{ route('topCustomersReport.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['topCustomersReport.index'])}}">
                        <span class="aiz-side-nav-text">{{ translate('Top Customers Report') }}</span>
                    </a>
                </li>  
                        
                    
                <li class="aiz-side-nav-item">
                    <a href="{{ route('top_selling_area_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['top_selling_area_report.index'])}}">
                        <span class="aiz-side-nav-text">{{ translate('Top Selling Area') }}</span>
                    </a>
                </li>  
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('stock_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['stock_report.index'])}}">
                            <span class="aiz-side-nav-text">{{ translate('Product Wise Stock Report') }}</span>
                        </a>
                    </li>
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('27', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('stock_ledger_report') }}" class="aiz-side-nav-link {{ areActiveRoutes(['stock_ledger_report'])}}">
                                <span class="aiz-side-nav-text">{{ translate('Products Stock Ledger Report') }}</span>
                            </a>
                        </li>
                    @endif 
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('picked_up_report') }}" class="aiz-side-nav-link {{ areActiveRoutes(['picked_up_report'])}}">
                                <span class="aiz-side-nav-text">{{ translate('Picked Up Report') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                        <a href="{{ route('customer_wishlist.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_wishlist.index'])}}">
                            <span class="aiz-side-nav-text">{{ translate('Customers wishlist') }}</span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <li class="aiz-side-nav-item">
                        <a href="{{ route('income_report.index') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Income Report') }}</span>
                        </a>
                    </li>
                        
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('salesCouponDiscountReport.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['salesCouponDiscountReport.index'])}}">
                            <span class="aiz-side-nav-text">{{ translate('Sales Coupon Discount Report') }}</span>
                        </a>
                     </li>           
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('stock_closing') }}" class="aiz-side-nav-link {{ areActiveRoutes(['stock_closing'])}}">
                            <span class="aiz-side-nav-text">{{ translate('Monthly Stock Closing') }}</span>
                        </a>
                    </li>
                @endif

                    <li class="aiz-side-nav-item">
                        <a href="{{ route('monthly_stock_ledger_report.index') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">Monthly Stock Ledger</span>
                        </a>
                    </li>
                    <!-- <li class="aiz-side-nav-item">
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <!-- <li class="aiz-side-nav-item">
                        <a href="{{ route('flash_deals.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['flash_deals.index', 'flash_deals.create', 'flash_deals.edit'])}}">
                            <span class="aiz-side-nav-text">{{ translate('Discount') }}</span>
                        </a>
                    </li>

                    <li class="aiz-side-nav-item">
                        <a href="{{ route('flash_deals.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['flash_deals.index', 'flash_deals.create', 'flash_deals.edit'])}}">
                            <span class="aiz-side-nav-text">{{ translate('Free Shipping') }}</span>
                        </a>
                    </li> -->
                    @endif
                    @if(Auth::user()->user_type == 'admin' || in_array('7', json_decode(Auth::user()->staff->role->permissions)))
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    @php
                    $conversation = \App\Conversation::where('receiver_id', Auth::user()->id)->where('receiver_viewed', '1')->get()->count();
                    $message = \App\Message::where('admin_viewed', '0')->get()->count();
                    @endphp
                    @if(Auth::user()->user_type == 'admin' || in_array('12', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
...
@if (Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
    ...
    <li class="aiz-side-nav-item">
        <a href="{{ route('slugs.all_slugs') }}" class="aiz-side-nav-link">
            <i class="las la-link aiz-side-nav-icon"></i>
            <span class="aiz-side-nav-text">{{ translate('Redirection') }}</span>
            {{-- <span class="aiz-side-nav-arrow"></span> --}}
        </a>
...
@endif
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{route('push_notification.create')}}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('Push Notification')}}</span>
                        </a>
                    </li>

                    <li class="aiz-side-nav-item">
                        <a href="{{route('app_footer.index')}}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('App Footer')}}</span>
                        </a>
                    </li>

                    <li class="aiz-side-nav-item">
                        <a href="{{route('app_slider.index')}}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('App Slider')}}</span>
                        </a>
                    </li>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-3">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('district.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['district.index','district.edit','district.update'])}}">
