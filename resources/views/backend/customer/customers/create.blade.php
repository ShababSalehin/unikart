...
<div class="row">
    <div class="col-lg-6 mx-auto">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('customers.save') }}" method="POST" enctype="multipart/form-data">
            	@csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" placeholder="{{translate('Phone')}}" id="mobile" name="mobile" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
