                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="number" lang="en" min="0"  onchange="calculateTP()" step="0.01" id="comission" value="{{ $comission }}" @if(Auth::user()->user_type=='seller') {{'readonly'}} @endif placeholder="{{translate('Seller Commission')}}" name="comission" class="form-control" required>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('App Discount')}}</label>
                            <div class="col-lg-6">
                            ...
                            <div class="col-md-3">
                                <select class="form-control aiz-selectpicker" id="app_discount_type"   name="app_discount_type">
                                    <option value="amount" <?php if ($product->app_discount_type == 'amount') echo "selected"; ?> >{{translate('Flat')}}</option>
                                    <option value="percent" <?php if ($product->app_discount_type == 'percent') echo "selected"; ?> >{{translate('Percent')}}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Seller Discount')}}</label>
                            <div class="col-lg-6">
                                @if($product->discount)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{$product->trade_price}}" readonly step="0.01" id="tp" placeholder="{{ translate('Unit price') }}" name="trade_price" class="form-control" required>
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{$product->unikart_discount}}"  step="0.01" id="unikart_discount" placeholder="{{ translate('Unikart Discount') }}" onkeyup="calculateTP()" onblur="calculateTP()"  onchange="calculateTP()" name="unikart_discount" class="form-control" >
                            </div>
                        </div>               
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{$product->unikart_earning}}" readonly step="0.01" id="unikart_earning" placeholder="{{ translate('Unikart Earning') }}" name="unikart_earning" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row" id="quantity">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" lang="en" value="{{ optional($product->stocks->first())->qty }}" step="1" placeholder="{{translate('Quantity')}}" name="current_stock" class="form-control" readonly>
                                </div>
                            </div>


                            <div class="form-group row" id="quantity">
                                <label class="col-lg-3 col-from-label">{{translate('Opening Quantity')}}</label>
                                <div class="col-lg-6">
                                    <input type="number" <?php if(optional($product->stocks->first())->opening_stock_qty>0) echo 'readonly';  ?> lang="en" value="{{ optional($product->stocks->first())->opening_stock_qty }}"  placeholder="{{translate('Opening Quantity')}}" name="opening_stock_qty"  class="form-control">
                                </div>
                            </div>
