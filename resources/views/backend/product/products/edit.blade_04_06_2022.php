                ...
                <div class="card">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                @if($product->discount)
                                <input type="number" lang="en" min="0" step="0.01"  onchange="calculateTP()" id="disc" placeholder="{{translate('Discount')}}" name="discount" class="form-control" value="{{ $product->discount }}" required>
                            @else
                            <input type="number" lang="en" min="0" step="0.01" onchange="calculateTP()" id="disc" placeholder="{{translate('Discount')}}" name="discount" class="form-control" value="0" required>
                            @endif
                            </div>
                            <div class="col-lg-3">
                                <select class="form-control aiz-selectpicker"  onchange="calculateTP()"  id="disc_type" name="discount_type" required>
