            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_id" data-live-search="true" required>
                                     <option value="">Please select cetagoty</option>
                        ...
                        <div class="form-group row">
						<label class="col-md-3 col-from-label">{{translate('Maximum Order Qty')}}</label>
						<div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row gutters-5">
                            ...
                            <div class="col-md-8">
                            <input type="text" placeholder="{{ translate('Special Feature') }}" name="beauty_features" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endphp
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Comission')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="number" lang="en" min="0" @if(Auth::user()->user_type=='seller') {{'readonly'}} @endif onchange="calculateTP()" step="0.01" id="comission" value="{{ $comission }}" placeholder="{{translate('Seller Commission')}}" name="comission" class="form-control" required>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('MRP')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" onchange="calculateTP()" id="mrp" placeholder="{{ translate('MRP') }}" name="unit_price" class="form-control" required>
                            </div>
                        </div>
                        
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('App Discount')}} </label>
                           
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('App price') }}" name="app_price" class="form-control">
                            </div>

                            <div class="col-md-3">
                                <select class="form-control aiz-selectpicker" id="app_discount_type"   name="app_discount_type">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Seller Discount')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="number" id="disc" lang="en" min="0" value="0" step="0.01" onchange="calculateTP()"  placeholder="{{ translate('Discount') }}" name="discount" class="form-control" required>
                            </div>
                            <div class="col-md-3">
                                <select class="form-control aiz-selectpicker" id="disc_type" onchange="calculateTP()"  name="discount_type">
                                    <option value="amount">{{translate('Flat')}}</option>
                                    <!-- <option value="percent">{{translate('Percent')}}</option> -->
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Trade Price')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="" readonly step="0.01" id="tp" placeholder="{{ translate('Unit price') }}" name="trade_price" class="form-control" required>
                            </div>
                        </div>
                            
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Unikart Discount')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0"  step="0.01" id="unikart_discount" placeholder="{{ translate('Unikart Discount') }}" onkeyup="calculateTP()" onblur="calculateTP()"  onchange="calculateTP()" name="unikart_discount" class="form-control" >
                            </div>
                        </div>    
                            
                            
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Unikart Earnings')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" readonly step="0.01" id="unikart_earning" placeholder="{{ translate('Unikart Earning') }}" name="unikart_earning" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" lang="en" min="0" value="0" step="1" placeholder="{{ translate('Quantity') }}" name="current_stock" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">
...
function calculateTP(){
    ...
    if(discount_type=='amount'){
        mrp = mrp-discount;
    	var unicart_discount=$('#unikart_discount').val();// added by alauddin
    }else{
        mrp = mrp-(mrp*discount)/100;
    	var unicart_discount=(mrp*$('#unikart_discount').val())/100;// added by alauddin
    }
    ...
    unikart_comission=unikart_comission-unicart_discount; // added by alauddin
    $('#tp').val(tp)
