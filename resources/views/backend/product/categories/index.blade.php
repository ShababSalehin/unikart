...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 text-md-right">
            ...
            <a href="{{ route('admin.menu_update') }}" class="btn btn-success">
                <span>{{translate('Update menu')}}</span>
            </a>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <table class="table aiz-table mb-0">
			...
			<td>{{ $category->level }}</td>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('categories.edit', ['id'=>$category->id, 'lang'=>env('DEFAULT_LANGUAGE','en')] )}}" title="{{ translate('Edit') }}">
