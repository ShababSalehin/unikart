        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="shop_banner" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Shops')}}</label>
                        <div class="col-md-9">
                            <select class="select2 form-control aiz-selectpicker" name="appbannerlink" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                <option value="-1">None</option>
                                @foreach (\App\Shop::all() as $shops)
