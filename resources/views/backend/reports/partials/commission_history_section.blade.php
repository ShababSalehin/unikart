<form id="culexpo" action="{{ route('commission-log.index') }}" method="GET">
    <div class="card-header row gutters-5">
        ...
        <div class="col-md-4">
        <button class="btn btn-primary" onclick="submitForm('{{ route('commission-log.index') }}')">{{ translate('Filter') }}</button>
        <button class="btn btn-primary" onclick="submitForm('{{ route('commission_history_download') }}')">{{ translate('Excel') }}</button>
