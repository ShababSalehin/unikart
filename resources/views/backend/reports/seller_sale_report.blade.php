...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-body">
                <form id="culexpo" action="{{ route('seller_sale_report.index') }}" method="GET">
                    <div class="form-group row offset-lg-2">
                        ...
                        <div class="col-md-4">
                        <button class="btn  btn-primary" onclick="submitForm ('{{ route('seller_sale_report.index') }}')">{{ translate('Filter') }}</button>
                        <button class="btn  btn-info" onclick="submitForm('{{ route('seller_sales_export') }}')">Excel</button>
