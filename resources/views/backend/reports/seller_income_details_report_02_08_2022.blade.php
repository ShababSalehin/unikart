                ...
                <table class="table table-bordered aiz-table mb-0 data-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($sellers as $key => $seller)
                            ...
                            $commission=$total_sale_info[0]['total_unikart_earning'];
                            ...
                            @endphp
                                <tr>
                                  ...
                                  <?php } ?>  
                                    <td>
                                        {{ $seller->coupon_discount}}{{get_only_currency_symbol()}}
                                    </td>
                                    <?php if($total_sale_info[0]['refund_status']==1){ ?>
                                        <td>
                                            {{ $total_sale}}{{get_only_currency_symbol()}}
                                        </td>
                    ...
                    <tfoot>
                        <tr class="border">
                            ...
                            <th>{{single_price($gtotal_commission)}}</th>
                            <th>{{single_price($gtotal_feeshipping_by_customer)}}</th>
                            <th>{{single_price($gtotal_feeshipping_by_seller)}}</th>
                            <th>{{single_price($gtotal_feeshipping_by_unicart)}}</th>
                            <th>{{single_price($gtotal_coupon)}}</th>
                            <th>{{single_price($gtotal_refunds)}}</th>
                            <th>{{single_price($gtotal_claims)}}</th>
                            <th>{{single_price($gtotal_seller_income)}}</th>
                            <th>{{single_price($gtotal_unicart_income)}}</th>
                        </tr>
                    </tfoot>
                </table>
                </div>
