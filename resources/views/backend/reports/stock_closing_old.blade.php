...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class=" align-items-center">
        <h1 class="h3">{{translate('Product Stock Closing')}}</h1>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 mx-auto">
        <div class="card">
            <!--card body-->
            <div class="card-body">
                <form id="culexpo" action="{{ route('stock_closing') }}" method="GET">
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 mt-4">
                            ...
                            <button class="btn btn-success" onclick="submitForm('{{ route('save_stock_closing') }}')">{{ translate('Save') }}</button>
...
th{text-align:center;}
                ...
                <h3 style="text-align:center;">{{translate('Product Stock Closing')}}</h3>
