            ...
            <form class="form-horizontal" action="{{ route('supplier.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="test" placeholder="{{translate('Address')}}" id="address" name="address" class="form-control" required>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="address">{{translate('Contact Person')}}</label>
                        <div class="col-sm-9">
                            <input type="test" placeholder="{{translate('Contact Person')}}" id="contact_person" name="contact_person" class="form-control" required>
                        </div>
                    </div>
