...
<div class="">
    <div class="">
        <form class="form form-horizontal mar-top" action="{{route('puracher_edit_store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
            ...
            <input type="hidden" name="purchase_id" value="{{$purchase_return->id}}">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6 pull-left">
                        ...
                        <select class="form-control aiz-selectpicker" name="return_number" id="return_number" data-live-search="true" required>
                            @foreach ($all_return as $return)
                            <option <?php if($return->return_number == $purchase_return->return_number) echo 'selected';?> value="{{ $return->return_number }}">{{ $return->return_number }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 pull-left">
                        ...
                        <input type="date" class="form-control" name="return_date" placeholder="{{ translate('Return Date') }}" value="{{$purchase_return->return_date}}" onchange="update_sku()" required>

                    </div>
                    <div class="col-md-6 pull-left">
                        <label>{{translate('Return No')}} <span class="text-danger">*</span></label>

                        <input type="text" readonly class="form-control" name="return_number" placeholder="{{ translate('Purchase No') }}" value="{{$purchase_return->return_number}}" onchange="update_sku()" required>
