    ...
    <section class="py-5">
        <div class="container">
            <div class="d-flex align-items-start">
                @include('frontend.inc.admin_sidenav')
                                        ...
                                        <tr>
                                            ...
                                            @if($refund->refund_status == 1)
                                                ...
                                                @elseif($refund->refund_status == 2)
                                                  ...
                                                  <span class="badge badge-inline badge-success">{{translate('Return In Progress')}}</span>
                                                  @elseif ($refund->refund_status == 4)
                                                  <span class="badge badge-inline badge-success">{{translate('Return Picked')}}</span> 
                                              @else
                                                  <span class="badge badge-inline badge-info">{{translate('Requested')}}</span>
                                               @endif
                                            </td>
                                            <td>
