                        ...
                        <div class="card">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            @if (addon_is_activated('otp_system'))
                                                <span class="opacity-60">{{  translate('USE YOUR 11 DIGIT PHONE NUMBER') }}</span>
                                            @endif
                                        </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('user.registration') }}" class="btn btn-primary btn-block fw-600">{{ translate('Create New Account')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
