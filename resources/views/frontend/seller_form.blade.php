                ...
                <form id="shop" class="" action="{{ route('shops.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-white rounded shadow-sm mb-4">
                        ...
                        <div class="p-3">
                            ...
                            <div class="form-group">
                                <label>{{ translate('Contact Persom')}} <span class="text-primary">*</span></label>
                                <input type="text" class="form-control" placeholder="{{ translate('Contact Persom')}}" name="contact_person" required>
                            </div>

                            <div class="form-group">
                                <label>{{ translate('Contact Number')}} <span class="text-primary">*</span></label>
                                <input type="number" class="form-control" placeholder="{{ translate('Contact Number')}}" name="contact_number" required>
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>{{ translate('Select City')}} <span class="text-primary">*</span></label>
