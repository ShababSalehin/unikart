...
@endif
<!-- Top Bar -->
<div id="top-header" style="height:25px;" class="border-bottom border-soft-secondary z-1035 d-none d-sm-block">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-right col">
                <ul style="margin-top:-3px;" class="list-inline d-flex justify-content-between justify-content-lg-start mb-0 float-right">
                    <li class="list-inline-item py-2 lang-list heading-text text-bold text-dark">Help Line: 01927000800</li>
                    <li class="list-inline-item py-2 lang-list heading-text text-dark">
                    <a class="text-dark" href="mailto:{{ get_setting('contact_email') }}" >Email:{{ get_setting('contact_email')  }}</a>
                    <li class="list-inline-item py-2 lang-list heading-text text-bold  text-dark">Live chat: (10AM to 7PM)</li>
                    <li class="list-inline-item py-2 lang-list heading-text text-dark">
                        <div class="nav-cart-box dropdown h-100 text-dark" id="header_lang" style="margin-right:10px;">
                            ...
                            <a class="text-dark" data-flag="{{ $language->code }}"
                                class="lang-change @if($locale == $language->code) active-lang @endif">
                                <span class="language">{{ translate(strtoupper($language->code)) }}</span>
                            </a>
                            @if($key == 0)
                            <span class="lang-change text-dark">|</span>
                            @endif
                            @endforeach
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-2 pl-0 pr-3 d-flex align-items-center">
                    <a style="margin-left:1rem" class="d-block py-10px mr-3 ml-0" href="{{ route('home') }}">
                        @php
                        $header_logo = get_setting('header_logo');
                        @endphp
                        @if($header_logo != null)
                        @if(Route::currentRouteName() == 'home')
                        <h1><img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                            class="mw-100 h-30px h-md-40px" height="40"></h1>
                        @else
                    ...
                    <div class="position-relative flex-grow-1">
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="input-group" style="border: 2px solid #fc5994 !important;border-radius: 7px;">
                                    <input style="border:none;border-radious:none;" type="text" class="border-0 form-control" id="search"
                                        name="keyword" @isset($query) value="{{ $query }}" @endisset
                                        placeholder="{{translate('Search for Products')}}" autocomplete="off">
                                    <div class="d-none d-lg-block">
                                        <button style="color:#fff;background:#fc5994;border:0px;border-left: 2px solid#fc5994;border-radius: 0px;margin: -1px;
                                        padding: 8px 10px;margin-right:-1px;border-bottom-right-radius: 5px;
                                        border-top-right-radius: 5px;" class="btn btn-primary" type="submit">
                ...
                <div class="d-none d-lg-block ml-3 mr-0">
                    <div class="">
                        <!-- <a href="Javascript:" class="d-flex align-items-center text-reset" data-toggle="modal" data-target="#expressShop">
                            <img style="width: 60px;" src="{{static_asset('assets/img/express.png')}}">
                ...
                <div class="d-none d-lg-block ml-3 mr-0">
                        @php
                        $newpdf = get_setting('newcustomerpdf');
                     
                        @endphp
                    <div class="" id="save_new">
                        <a href="{{route('fornewcustomer')}}">
                            <p class="h6 fw-700">20% Save</p>
    ...
    <div id="header-bottom" class="bg-white  border-gray-200 py-1 d-none">
        <div class="container">
            <div class="d-flex align-items-center">
                <div class="w-200px d-none d-xl-block d-xl-flex align-self-stretch category-menu-icon-box mr-0 ">
                    <div class="h-100 d-flex align-items-center" id="category-menu-icon">
                        <div class="dropdown-toggle navbar-light  h-20px w-50px pl-2 ">
                            <span class="navbar-toggler-icon"></span><span
                                style="margin-left: 5px;color: #000;font-size:14px;">Category</span>
                        </div>
                    </div>
                </div>
