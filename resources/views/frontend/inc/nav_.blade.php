...
@endif
<!-- Top Bar -->
<div id="top-header" class="top-navbar border-bottom border-soft-secondary z-1035">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-right col">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0 float-right">
                    <li class="list-inline-item py-2 lang-list heading-text"><a
                            href="{{route('save-more-app')}}">Extra Save on App</a></li>
                    <li class="list-inline-item py-2 lang-list heading-text"><a href="mailto:info@beautyshop.com">Email:
                            info@beautyshop.com</a></li>
                    <li class="list-inline-item py-2 lang-list heading-text"><a href="callto:0234234124">Hotline:
                            0234234124 (10AM to 6PM)</a></li>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-none d-lg-block ml-3 mr-0">
                    ...
                    <div class="" id="save_new">
                        <a href="{{uploaded_asset($newpdf) }}" target="blank"  >
                            <h6>20% Save</h6>
            ...
            <div class="d-flex align-items-center">
                ...
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center d-flex">
                    ...
                    <li class="list-inline-item mr-0">
                        <a href="http://localhost/beauty-shop/flash-deal/specials-offer-oyeer"
