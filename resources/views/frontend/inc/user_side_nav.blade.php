        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                @else
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('orders.track') }}" class="aiz-side-nav-link {{ areActiveRoutes(['orders.track'])}}">
                            <i class="las la-download aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Track My Order') }}</span>
                        </a>
                    </li>
                    <!--<li class="aiz-side-nav-item">-->
                    <!--    <a href="Javascript:" class="aiz-side-nav-link {{ areActiveRoutes(['orders.track'])}}">-->
                    <!--        <i class="las la-reply aiz-side-nav-icon"></i>-->
                    <!--        <span class="aiz-side-nav-text">{{ translate('Return & Cancellations') }}</span>-->
                    <!--    </a>-->
                    <!--</li>-->
                    ...
                    @endif
                    <li class="aiz-side-nav-item">
                    <a href="{{ route('coupon_usage.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['coupon_usage.index'])}}">
                    ...
                    @if (get_setting('conversation_system') == 1)
                        @php
                            $conversation = \App\Message::where('receiver_id', Auth::user()->id)->where('receiver_viewed', 0)->get();
                            @endphp
                        <li class="aiz-side-nav-item">
                ...
                @if (Auth::user()->user_type == 'customer')
                <li class="aiz-side-nav-item">
                    <a href="{{ route('followed-shop') }}" class="aiz-side-nav-link {{ areActiveRoutes(['followed-shop'])}}">
                        <i class="las la-home aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('My Followed Shop')}}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('my-review') }}" class="aiz-side-nav-link {{ areActiveRoutes(['my-review'])}}">
                        <i class="las la-home aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('My Review')}}</span>
                    </a>
                </li>
