...
<body>
    <section class="py-4 mb-4 bg-light">
        <div class="container text-center">
          <form action="{{route('api.bkash.checkout',['token'=>$token,'amount'=>$amount,'order_id'=> $order_id ])}}" method="get">
    ...
    <script type="text/javascript">        
       ...
       /* var paymentID = '';
        ...
        $.ajax({
          url: '{{ route('api.bkash.checkout',['token'=>$token, 'amount'=>$amount,'order_id'=> $order_id ]) }}',
          type: 'POST',
