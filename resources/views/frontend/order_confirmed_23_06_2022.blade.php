                                            ...
                                            <tbody>
                                                @foreach ($order->orderDetails as $key => $orderDetail)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">{{ single_price($orderDetail->price+$order->orderDetails->sum('discount')) }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                            ...
                                            <table class="table ">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                           <strong> <span class="font-italic">{{ single_price($order->orderDetails->sum('discount')) }}</span></strong>
                                                        </td>
                                                    </tr>
                                                    <tr>
