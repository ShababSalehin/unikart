...
<div class="modal-body gry-bg px-3 pt-3">
    <div class="py-4">
        <div class="row gutters-5 text-center aiz-steps">
            ...
            <div class="col @if($status == 'picked_up') active @elseif( $status == 'on_delivery' || $status == 'delivered') done @endif">
                <div class="icon">
            ...
            <div class="col @if($status == 'on_the_way') active @elseif($status == 'delivered') done @endif">
                <div class="icon">
                    <i class="las la-truck"></i>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="w-50 fw-600">{{ translate('Payable amount')}}:</td>
                        ...
                        <tbody>
                            @foreach ($order->orderDetails as $key => $orderDetail)
                                ...
                                @endif
                                    ...
                                    <td>{{ single_price($orderDetail->product_unit_price) }}</td>
                                    @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                        @php
                                        ...
                                        <td>
                                            ...
                                            (!empty($orderDetail->product->refundable) && $orderDetail->product->refundable != 0) &&
                                            ...
                                            @elseif ($orderDetail->refund_request != null && $orderDetail->refund_request->refund_status == 3)
                                                <b class="text-success">{{  translate('Return In Progress') }}</b>
                                            @elseif ($orderDetail->refund_request != null && $orderDetail->refund_request->refund_status == 4)
                                                <b class="text-success">{{  translate('Return Picked') }}</b>
                                            @elseif (!empty($orderDetail->product->refundable) && $orderDetail->product->refundable != 0)
                                                <b>{{  translate('N/A') }}</b>
                                            @else
                                   ...
                                   <a href="{{route('make_review',$orderDetail->product_id)}}" class="btn btn-primary btn-sm">
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right">
                                    <span class="strong-600">{{ single_price($order->orderDetails->sum('price')+$order->orderDetails->sum('discount')) }}</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price($order->orderDetails->sum('discount')) }}</span>
                                </td>
                            </tr>
