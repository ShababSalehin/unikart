                            ...
                            @if (count($order->orderDetails) > 0)
                                <tr>
                                    ...
                                    @if ($order->orderDetails->first()->delivery_status == 'pending' || 
                                        $order->orderDetails->first()->delivery_status == 'confirmed' || 
                                        $order->orderDetails->first()->delivery_status == 'picked_up'  &&
                                         $order->payment_status == 'pending')
                                            <a href="javascript:void(0)" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('orders.cancel', $order->id)}}" title="{{ translate('Cancel') }}">
