            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
						...
						<div class="col-md-8">
							<input type="number" lang="en" class="form-control" name="max_qty" value="5" min="1">
						</div>
					</div>
                    <div class="form-group row">
            ...
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="hidden" lang="en" min="0" @if(Auth::user()->user_type=='seller') {{'readonly'}} @endif onchange="calculateTP()" step="0.01" id="comission" value="{{ $comission }}" placeholder="{{translate('Seller Commission')}}" name="comission" class="form-control" required>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label"><span class="text-danger"></span></label>
                            <div class="col-md-6">
                                <input type="hidden" lang="en" min="0" value="" readonly step="0.01" id="tp" placeholder="{{ translate('Unit price') }}" name="trade_price" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label"><span class="text-danger"></span></label>
                            <div class="col-md-6">
                                <input type="hidden" lang="en" min="0" value="0" readonly step="0.01" id="unikart_earning" placeholder="{{ translate('Unikart Earning') }}" name="unikart_earning" class="form-control" required>
                            </div>
                        </div>
