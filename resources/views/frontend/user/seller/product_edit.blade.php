                ...
                <div class="card">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="hidden" lang="en" min="0" value="{{$product->unikart_discount}}"  step="0.01" id="unikart_discount" placeholder="{{ translate('Unikart Discount') }}" onkeyup="calculateTP()" onblur="calculateTP()"  onchange="calculateTP()" name="unikart_discount" class="form-control" >
