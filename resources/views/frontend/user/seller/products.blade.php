        ...
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="type" id="type" onchange="sort_products()">
                    ...
                    <option value="1" @isset($col_name) @if($col_name == '1') selected @endif @endisset>{{translate('Approved')}}</option>
                    <option value="0" @isset($col_name) @if($col_name == '0') selected @endif @endisset>{{translate('Pending')}}</option>
                    <option value="">{{ translate('All') }}</option>
                    <!-- <option value="cancelled" @isset($col_name ) @if($col_name == 'cancelled') selected @endif @endisset>{{translate('Cancelled')}}</option> -->
                ...
                <tbody>
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
		                      <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{route('seller.products.edit', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE','en')])}}" title="{{ translate('Edit') }}">
