    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <label class="col-md-2 col-form-label">{{ translate('Contact Persom ') }}<span class="text-danger text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Contact Persom ')}}" name="contact_person" value="{{ $shop->contact_person }}" required>
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-2 col-form-label">{{ translate('Contact Number ') }}<span class="text-danger text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="number" class="form-control mb-3" placeholder="{{ translate('Contact Number ')}}" name="contact_number" value="{{ $shop->contact_number }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-md-2 col-form-label">{{ translate('Shop Logo') }}<small>({{ translate('180x180') }})</small></label>
                    <div class="col-md-10">
