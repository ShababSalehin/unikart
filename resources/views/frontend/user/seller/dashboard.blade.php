...
<div class="aiz-titlebar mt-2 mb-4">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <a href="{{route('seller.products')}}" class="aiz-side-nav-link">
              <div class="px-3 pt-3">
                <div class="h3 fw-700 text-white">
                  {{ count(\App\Product::where('user_id', Auth::user()->id)->get()) }}
                </div>
                <div class="opacity-70 text-white">{{ translate('Products')}}</div>
              </div>
            ...
            <a href="{{ route('orders.index') }}" class="aiz-side-nav-link">
                <div class="px-3 pt-3">
                   <div class="h3 fw-700 text-white">
                    ...
                    <div class="opacity-50 text-white">{{ translate('Total Sales')}}</div>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        <div class="col-md-3">
            <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                <a href="{{ route('seller_income_report.details', Auth::user()->id) }}"><div class="px-3 pt-3">
                    @php
                        $orderDetails = \App\OrderDetail::where('seller_id', Auth::user()->id)->get();
                        $total = 0;
                        foreach ($orderDetails as $key => $orderDetail) {
                            if($orderDetail->order != null && $orderDetail->order->payment_status == 'paid' && $orderDetail->refund_status == 0){
                                $total += $orderDetail->price;
                            }
                        }
                    @endphp
                    <div class="h3 fw-700 text-white">{{ single_price($total) }}</div>
                    <div class="opacity-50 text-white">{{ translate('Income Details') }}</div>
                  </div></a>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        <div class="col-md-3">
          ...
          <div class="card">
              ...
              <div class="col-md-4 aiz-titlebar">
              <h1 class="h3">Order</h1>
              <p class="mb-1"><a href="{{route('orders.index') }}">TOTAL ORDER</a></p>
             
              <p class="mb-1"><a href="{{route('orders.successfull') }}">SUCCESSFUL ORDER</a></p>
              <p class="mb-1"><a href="{{ route('vendor_refund_request') }}">RETURN ORDER</a></p>
              </div>
              <div class="col-md-4 aiz-titlebar">
              <h1 class="h3">Product</h1>
              <p class="mb-1"><a href="{{route('seller.products') }}">All PRODUCT</a></p>
              <p class="mb-1"><a href="{{route('approved.product') }}">APPROVED PRODUCT</a></p>
              <p class="mb-1"><a href="{{route('pending.product') }}">PENDING PRODUCT</a></p>
              
              </div>
              <div class="col-md-4 aiz-titlebar">
              <h1 class="h3">Rating</h1>
              <p class="mb-1"><a href="{{ route('reviews.seller') }}">POSITIVE SELLER RATING</a></p>
              <!-- <p class="mb-1"><a>CHAT RESPONSE RATE</a></p>
              <p class="mb-1"><a>CANCELLATION RATE</a></p> -->
          ...
          <div class="card-header">
              ...
              <div class="col-md-4">
                  ...
                  <a href="{{ route('flash-deal-details', $single->slug) }}" class="d-block text-reset">
                    ...
                    @if(isJoinFlashDeas($single->id)>0)
                        Joined
                    @else
                        Join
                    @endif
    ...
    <div class="row">
        <div class="col-md-4">
          <div class="card">
              <div class="card-header">
                  <h5 class="mb-0 h6">{{ translate('CHAT') }}</h5>
              </div>
              <div class="card-body row gutters-5 px-2">
                <div class="col-md-6 mb-2">
                    <div class="border">
                        <p class="text-center px-1 py-2 mb-0">RESPONSE RATE <br>100.00%</p>
                    </div>
                </div>  
                <div class="col-md-6 mb-2">
                <div class="border">
                        <p class="text-center px-1 py-2 mb-0">RESPONSE TIME <br>100.00%</p>
                    </div>
                </div>  
                <div class="col-md-6 mb-2">
                <div class="border">
                        <p class="text-center px-1 py-2 mb-0">CONVERSION RATE <br>100.00%</p>
                    </div>
                </div>  
                <div class="col-md-6 mb-2">
                <div class="border">
                        <p class="text-center px-1 py-2 mb-0">CONVERSATIONS <br>00</p>
                    </div>
                </div>  
              </div>
          </div>
    ...
    <!-- <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="col-lg-2 aiz-titlebar">
        <h1 class="h3">{{ translate('NOTICE') }}</h1>
        <hr class="m-0">
