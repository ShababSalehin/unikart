    ...
    <form action="{{ route('seller.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">{{ translate('Photo') }}<small>({{ translate('180x180') }})</small></label>
                    <div class="col-md-10">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control mb-3" placeholder="{{ translate('Bank Branch Name')}}" value="{{ Auth::user()->seller->bank_routing_no }}" name="bank_routing_no">
                </div>
            </div>
          </div>
      </div>
