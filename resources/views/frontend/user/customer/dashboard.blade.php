                ...
                @if(Auth::user()->addresses != null)
                    ...
                    @if($address != null)
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class=" py-2"><span>{{ translate('Country') }} : {{ get_country_name( $address->country_id)[0] }}</span></li>
                            <li class=" py-2"><span>{{ translate('City') }} : {{ get_city_name($address->city_id)[0] }}</span></li>
