                                ...
                                @php
                                   ...
                                   // $total = $total + ($cartItem['price'] * $cartItem['quantity']) + $cartItem['tax'];
									if($cartItem['offer_status']==1){
                                       // $disc=$product->unit_price-$cartItem['price'];
                                        ...
                                        <div class="col-lg col-6 order-4 order-lg-0">
                                            @if($cartItem['digital'] != 1)
                                                <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
                                                    ...
                                                    <input type="number" name="quantity[{{ $cartItem['id'] }}]" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="{{ $cartItem['quantity'] }}" min="{{ $product->min_qty }}" max="{{ $product->max_qty }}" onchange="updateQuantity({{ $cartItem['id'] }}, this)">
