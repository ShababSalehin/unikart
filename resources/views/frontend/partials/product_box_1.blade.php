...
<div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
    <div class="position-relative">
        ...
        <div class="absolute-top-left aiz-p-hov-icon">
        ...
        @endphp
        <span class="fw-900 px-3 bg-primary text-white font">-{{ $discountpercentage }}%</span>
        @endif
        </div>
    ...
    <div class="p-md-3 p-2 text-center">
        ...
        <div class="fs-15">
           @if($product->app_price)
            <span class="fw-700 text-primary">App price: ৳{{ get_app_price($product) }}</span>
            @else
