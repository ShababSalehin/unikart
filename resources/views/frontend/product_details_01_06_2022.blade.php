            ...
            <div class="row">
                                        ...
                                        <div class="product-quantity d-flex align-items-center">
                                            <div class="row no-gutters align-items-center aiz-plus-minus mr-3"
                                                ...
                                                <input type="number" name="quantity"
                                                    ...
                                                    min="{{ $detailedProduct->min_qty }}" max="5">
                                                <button class="btn  col-auto btn-icon btn-sm btn-circle btn-light"
                ...
                <div class="col-xl-3 bg-secondary-custom pd-right-section">
                  ...
                  <div class="w-100 pd-right-header">
                    ...
                    <button style="background-color: #FFF;" class="btn btn-sm  btn-link line-height-1 pd-right-but-padding"><span style="font-size: 9px;" >{{ translate('Proitive seller Rating')}}</span><br>
                  ...
                  <hr>
                                ...
                                <div class="col-sm-9">
                                    <div class="my-2"> <b>{{format_price(\App\Shop::where('user_id', $detailedProduct->user_id)->first()->shipping_cost)}}</b></div>
                                </div>
                            </div>
                  <hr>
                  <!-- @php
                ...
                <div class="bg-white mb-3 shadow-sm rounded">
                    <div class="nav border-bottom aiz-nav-tabs">
                        <a href="#tab_default_5" data-toggle="tab"
                            class="p-3 fs-16 fw-600 text-reset active show">{{ translate('Specification')}}</a>
