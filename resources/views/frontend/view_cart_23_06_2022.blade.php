                                        ...
                                        <div class="row gutters-5">
                                            ...
                                            <div class="col-lg col-4 order-2 order-lg-0 my-3 my-lg-0">
                                    			...
                                    			<?php if($cartItem['offer_status']==1){ ?>
                                                    <span class="fw-600 fs-16">{{ single_price($cartItem['offer_discount_amount']) }}</span>
                                                <?php }else{ ?>
                                            ...
                                            <div class="col-lg col-4 order-3 order-lg-0 my-3 my-lg-0">
                                                ...
                                                <?php }else{ ?>
                                                    <span class="fw-600 fs-16 text-primary">{{ single_price(($cartItem['price'] - $cartItem['discount']) * $cartItem['quantity']) }}</span>
                                                <?php } ?>   
                                            </div>
